      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-3 mb-8">
            <Layers className="text-brand-navy" size={32} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {chemicals.map((chem, index) => (
              <div
                key={index}
                className="bg-white border border-gray-200 p-8 rounded-xl text-center hover:shadow-lg transition-shadow hover:border-[#84A0C3]"
              >
                <div className="w-16 h-16 bg-brand-navy-mid rounded-full mx-auto mb-4 flex items-center justify-center">
                  <Layers className="text-brand-navy" size={32} />
                </div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">{chem.category}</h3>
                <p className="text-brand-gray text-sm">{chem.description}</p>
              </div>
            ))}
          </div>

          <div className="mt-8 p-6 bg-brand-navy-light border border-[#ADBFD9] rounded-xl">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-brand-navy-light to-brand-navy-mid p-8 rounded-xl border border-[#ADBFD9]">
